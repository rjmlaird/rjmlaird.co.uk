import { c as routeIsFallback, l as routeIsRedirect, n as callGetStaticPaths, o as getFallbackRoute, u as stringifyParams } from "./route-cache-JXnJQu0f.js";
	...
	*/
	async #getPathsForRoute(route) {
		...
		const staticPaths = await callGetStaticPaths({
			mod: await this.#app.pipeline.getComponentByRoute(route),
			route: (routeIsRedirect(route) ? route.redirectRoute : routeIsFallback(route) ? getFallbackRoute(route, manifest.routes) : route) ?? route,
			routeCache,
