import { f as removeLeadingForwardSlash, i as collapseDuplicateTrailingSlashes, l as joinPaths, m as removeTrailingForwardSlash, n as collapseDuplicateLeadingSlashes, o as hasFileExtension, r as collapseDuplicateSlashes, s as isInternalPath, t as appendForwardSlash, u as prependForwardSlash } from "./path-DSAdOJJi.js";
import { n as matchPattern } from "./remote-BgpFkaRQ.js";
import { $ as AstroError, D as MiddlewareNotAResponse, E as MiddlewareNoDataOrNextCalled, G as SessionStorageSaveError, H as ResponseSentError, K as StaticClientAddressNotAvailable, L as PrerenderClientAddressNotAvailable, Q as i18nNoLocaleFoundInPath, T as LocalsReassigned, W as SessionStorageInitError, a as ClientAddressNotAvailable, f as ForbiddenRewrite, i as CacheNotEnabled, n as ActionsReturnedInvalidDataError, r as AstroResponseHeadersReassigned, t as ActionNotFoundError } from "./errors-data-C-LagFHt.js";
import { i as generateCspDigest } from "./encryption-DINZzsp4.js";
import { escape } from "./astro_n_html-escaper.js";
import { a as REDIRECT_STATUS_CODES, d as pipelineSymbol, f as responseSentSymbol$1, l as fetchStateSymbol, n as ASTRO_GENERATOR, o as REROUTABLE_STATUS_CODES, s as appSymbol, t as ASTRO_ERROR_HEADER, u as originPathnameSymbol } from "./constants-Db_UM6zU.js";
import s from "./astro_n_piccolore.js";
import { renderEndpoint } from "./astro_runtime_server_endpoint__js.js";
import { a as renderPage } from "./server-BrkDvFqK.js";
import { n as isRoute500, t as isRoute404 } from "./route-errors-Xv1dymiW.js";
import { d as getRouteGenerator, i as getCustom404Route, s as routeHasHtmlExtension } from "./route-cache-JXnJQu0f.js";
import { t as require_dist } from "./astro_n_cookie.js";
import { i as unflatten$1, r as parse$1, t as stringify$1 } from "./devalue-Cp0K9u37.js";
import "./astro_n_es-module-lexer.js";
import { n as createStorage } from "./dist-BeU4TRtu.js";
import { C as createCrossOriginForbiddenResponse, S as getProps, _ as MultiLevelEncodingError, b as Slots, c as SERVER_ISLAND_COMPONENT, f as sequence, g as setOriginPathname, h as getOriginPathname, l as BodySizeLimitError, o as routeComparator, p as copyRequest, r as PipelineFeatures, t as ALL_PIPELINE_FEATURES, u as readBodyWithLimit, v as validateAndDecodePathname, w as isForbiddenCrossOriginRequest, x as getParams, y as shouldAppendForwardSlash } from "./base-pipeline-z4-S2vlN.js";
...
function serializeActionResult(res) {
	if (res.error) {
		if (import.meta.env?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
	...
	let body;
	try {
		body = stringify$1(res.data, { URL: (value) => value instanceof URL && value.href });
	} catch (e) {
...
var stringify = (data, _) => {
	return stringify$1(data, { URL: (val) => val instanceof URL && val.href });
};
...
//#endregion
export { getCookiesFromResponse as _, TrailingSlashHandler as a, pathHasLocale as b, FetchState as c, matchAllRoutes as d, matchRoute as f, attachCookiesToResponse as g, I18n as h, CacheHandler as i, validateHost as l, AstroMiddleware as m, provideSession as n, prepareResponse as o, PagesHandler as p, renderRedirect as r, ActionHandler as s, AstroHandler as t, setRenderOptions as u, getSetCookiesFromResponse as v, computePathnameFromDomain as y };
