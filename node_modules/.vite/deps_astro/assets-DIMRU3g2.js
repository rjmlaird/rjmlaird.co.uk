import { c as isRemotePath, l as joinPaths, p as removeQueryString } from "./path-DSAdOJJi.js";
import { t as isRemoteAllowed } from "./remote-BgpFkaRQ.js";
import { $ as AstroError, C as LocalImageUsedWrongly, O as MissingImageDimension, X as UnsupportedImageConversion, Z as UnsupportedImageFormat, _ as IncompatibleDescriptorOptions, c as ExpectedImageOptions, l as ExpectedNotESMImage, s as ExpectedImage, x as InvalidImageService, z as RemoteImageNotAllowed } from "./errors-data-C-LagFHt.js";
import { i as VALID_SUPPORTED_FORMATS, n as DEFAULT_OUTPUT_FORMAT, t as DEFAULT_HASH_PROPS } from "./consts-Bx4_lkUX.js";
import { t as inferRemoteSize } from "./remoteProbe-FWcCURZq.js";
...
var baseService = {
	...
	getURL(options, imageConfig) {
		...
		let url = `${joinPaths(import.meta.env.BASE_URL, imageConfig.endpoint.route)}?${searchParams}`;
...
//#endregion
export { baseService as a, isESMImportedImage as c, getImage as i, propsToFilename as n, isLocalService as o, getConfiguredImageService as r, verifyOptions as s, hashTransform as t };
