import { i as serializeRouteData, n as deserializeRouteData } from "./manifest-C8TPgA5G.js";
...
async function handle(request, env, context) {
	if (isPrerender) {
		if (compileImageConfig) {
			const { installAddStaticImage } = await import("./static-image-collection-DsxVE0YR.js");
