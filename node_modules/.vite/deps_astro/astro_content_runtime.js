import { c as isRemotePath, d as removeBase, u as prependForwardSlash } from "./path-DSAdOJJi.js";
import { $ as AstroError, B as RenderUndefinedEntryError, S as LiveContentConfigError, Y as UnknownContentCollectionError, et as AstroUserError, p as GetEntryDeprecationError } from "./errors-data-C-LagFHt.js";
import { r as VALID_INPUT_FORMATS } from "./consts-Bx4_lkUX.js";
import { Cr as safeParseAsync, Gn as string, Kt as date, Mn as number, Nn as object, Pt as array, rr as union } from "./v4-43CPwBdp.js";
import { escape } from "./astro_n_html-escaper.js";
import { createComponent } from "./astro_runtime_server_astro-component__js.js";
import { unescapeHTML } from "./astro_runtime_server_escape__js.js";
import { B as renderTemplate, s as renderComponent } from "./server-BrkDvFqK.js";
...
import { i as unflatten } from "./devalue-Cp0K9u37.js";
import { Traverse } from "./astro_n_neotraverse_modern.js";
import { createSvgComponent } from "./astro_assets_runtime.js";
...
function defineLiveCollection() {
	throw new AstroError({
		...LiveContentConfigError,
		message: LiveContentConfigError.message("Live collections must be defined in a `src/live.config.ts` file.")
	});
}
...
//#endregion
export { LiveCollectionCacheHintError, LiveCollectionError, LiveCollectionValidationError, LiveEntryNotFoundError, createDeprecatedFunction, createGetCollection, createGetEntries, createGetEntry, createGetLiveCollection, createGetLiveEntry, createReference, defineCollection, defineLiveCollection, renderEntry, updateImageReferencesInData };
