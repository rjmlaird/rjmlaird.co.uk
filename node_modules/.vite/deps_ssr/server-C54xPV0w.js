import { F as NoMatchingRenderer, L as OnlyResponseCanBeReturned, M as NoClientOnlyHint, W as ResponseSentError, tt as AstroError } from "./errors-data-DG2Ds6LK.js";
import { i as generateCspDigest, r as encryptString } from "./encryption-BohM8bKC.js";
import { shorthash } from "./astro_runtime_server_shorthash__js.js";
import { n as isRoute500, t as isRoute404 } from "./route-errors-Xv1dymiW.js";
import "./astro_runtime_server_astro-global__js.js";
import "./astro_runtime_server_endpoint__js.js";
import { isPromise } from "./astro_runtime_server_util__js.js";
import { HTMLString, escapeHTML, isHTMLString, markHTMLString, stringifyForScript, unescapeHTML } from "./astro_runtime_server_escape__js.js";
import { n as isPropagatingHint } from "./resolver-DuL4xQXc.js";
import { isAstroComponentFactory } from "./astro_runtime_server_render_astro_factory__js.js";
import { clsx } from "./astro_n_clsx.js";
import { serializeProps } from "./astro_runtime_server_serialize__js.js";
import { extractDirectives, generateHydrateScript } from "./astro_runtime_server_hydration__js.js";
import { createThinHead, isHeadAndContent } from "./astro_runtime_server_render_astro_head-and-content__js.js";
import { determineIfNeedsHydrationScript, determinesIfNeedsDirectiveScript, getPrescripts } from "./astro_runtime_server_scripts__js.js";
import { a as shouldRenderInstruction, i as registerIfPropagating, n as getInstructionRenderState, t as bufferPropagatedHead } from "./runtime-EWS1lsGD.js";
import { renderCspContent } from "./astro_runtime_server_render_csp__js.js";
import { createRenderInstruction, isRenderInstruction, isScriptInstruction } from "./astro_runtime_server_render_instruction__js.js";
import { INVALID_ATTR_NAME_CHAR, addAttribute, createBufferedRenderer, formatList, internalSpreadAttributes, isDeno, isNode, promiseWithResolvers, renderElement as renderElement$1, toAttributeString, voidElementNames } from "./astro_runtime_server_render_util__js.js";
import { maybeRenderHead, renderAllHeadContent } from "./astro_runtime_server_render_head__js.js";
import { SERVER_ISLAND_START } from "./astro_runtime_server_render_server-islands-shared__js.js";
import "./astro_runtime_server_render_tags__js.js";
import "./transition-tNaueeVa.js";
...
${serializeProps(props, metadata)}`);
	...
	if (componentServerRenderEndTime && true) island.props["server-render-time"] = componentServerRenderEndTime;
	let unrenderedSlots = [];
	if (html) {
...
function mergeSlots(...slotted) {
	...
	for (const slot of slotted) {
		...
		else if (typeof slot === "function") Object.assign(slots, mergeSlots(slot()));
	}
	return slots;
}
...
//#endregion
export { renderServerIslandRuntime as A, renderTemplate as B, chunkToByteArrayOrString as C, isRenderInstance as D, encoder as E, renderSlot as F, createVNode as H, renderSlotToString as I, renderSlots as L, createSlotValueFromString as M, isSlotString as N, ServerIslandComponent as O, mergeSlotInstructions as P, RenderTemplateResult as R, chunkToByteArray as S, decoder as T, isVNode as U, AstroJSX as V, transformSlots as W, createAstroComponentInstance as _, renderPage as a, Fragment as b, renderComponentToString as c, bufferHeadContent as d, renderToAsyncIterable as f, AstroComponentInstance as g, renderStreaming as h, spreadAttributes as i, SlotString as j, containsServerDirective as k, componentIsHTMLElement as l, renderToString as m, defineStyleVars as n, renderJSX as o, renderToReadableStream as p, mergeSlots as r, renderComponent as s, __astro_tag_component__ as t, renderHTMLElement as u, isAstroComponentInstance as v, chunkToString as w, Renderer as x, renderChild as y, isRenderTemplateResult as z };
