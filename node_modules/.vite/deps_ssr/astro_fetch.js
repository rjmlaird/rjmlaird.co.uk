import { a as TrailingSlashHandler, c as FetchState$1, h as I18n, i as CacheHandler, m as AstroMiddleware, n as provideSession, p as PagesHandler, r as renderRedirect, s as ActionHandler, t as AstroHandler } from "./handler-B6C2jMol.js";
import { s as appSymbol } from "./constants-Db_UM6zU.js";
//#region node_modules/astro/dist/core/fetch/index.js
function getApp(request) {
	const app = Reflect.get(request, appSymbol);
	if (!app) throw new Error("FetchState(request) called on a request without an attached app. Ensure it runs inside Astro's request pipeline.");
	return app;
}
