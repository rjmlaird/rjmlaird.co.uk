...
async function stringifyAsync(value, reducers) {
	...
	for (let i = 0; i < stringified.length; i += 1) {
		...
		if (typeof value !== "string") {
			await value;
			value = stringified[i];
			if (i === 0 && value < 0) return `${value}`;
		}
		out += value;
		if (i < stringified.length - 1) out += ",";
	}
	out += "]";
	return out;
}
...
//#endregion
export { uneval as a, unflatten as i, stringifyAsync as n, DevalueError as o, parse as r, stringify as t };
