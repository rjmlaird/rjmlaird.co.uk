...
import { t as __commonJSMin } from "./chunks/rolldown-runtime_BVj4LQFE.mjs";
import { $ as ASTRO_GENERATOR, G as createVNode, Q as ASTRO_ERROR_HEADER, U as isAstroComponentFactory, V as isRenderInstruction, W as AstroJSX, X as isRoute500, Y as isRoute404, Z as escape, _ as decryptString, a as renderPage, at as fetchStateSymbol, c as renderStreaming, ct as responseSentSymbol$1, d as createSlotValueFromString, dt as s, et as DEFAULT_404_COMPONENT, g as decodeKey, h as renderTemplate, it as clientAddressSymbol, m as isRenderTemplateResult, nt as REROUTABLE_STATUS_CODES, o as renderJSX, ot as originPathnameSymbol, p as renderSlotToString, q as renderEndpoint, rt as appSymbol, s as renderComponent, st as pipelineSymbol, tt as REDIRECT_STATUS_CODES, u as chunkToString, v as generateCspDigest } from "./chunks/server_ClKh5Vov.mjs";
import { a as fileExtension, f as removeLeadingForwardSlash, g as trimSlashes, h as slash, i as collapseDuplicateTrailingSlashes, l as joinPaths, m as removeTrailingForwardSlash, n as collapseDuplicateLeadingSlashes, o as hasFileExtension, r as collapseDuplicateSlashes, s as isInternalPath, t as appendForwardSlash, u as prependForwardSlash } from "./chunks/path_BqUacSWD.mjs";
import { a as enumerable_symbols, c as is_primitive, d as valid_array_indices, i as DevalueError, l as stringify_key, n as unflatten$1, o as get_type, r as encode64, s as is_plain_object, t as parse$1, u as stringify_string } from "./chunks/parse_DYC_yjKv.mjs";
import { A as MiddlewareNoDataOrNextCalled, C as InvalidGetStaticPathsEntry, H as PrerenderClientAddressNotAvailable, J as RewriteWithBodyUsed, K as ReservedSlotName, O as LocalsNotAnObject, Q as UnableToLoadLogger, U as PrerenderDynamicEndpointPathCollide, V as PageNumberParamNotFound, X as SessionStorageSaveError, Y as SessionStorageInitError, Z as StaticClientAddressNotAvailable, _ as GetStaticPathsExpectedParams, a as AstroResponseHeadersReassigned, h as ForbiddenRewrite, i as ActionsReturnedInvalidDataError, j as MiddlewareNotAResponse, k as LocalsReassigned, n as AstroUserError, o as CacheNotEnabled, q as ResponseSentError, r as ActionNotFoundError, rt as i18nNoLocaleFoundInPath, s as ClientAddressNotAvailable, t as AstroError, v as GetStaticPathsInvalidRouteParam, w as InvalidGetStaticPathsReturn, y as GetStaticPathsRequired, z as NoMatchingStaticPathFound } from "./chunks/errors_BL7sPB4q.mjs";
import { n as matchPattern } from "./chunks/remote_Cm3aSJjJ.mjs";
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SSR": true
		}, { _: "/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": "https://rjmlaird.co.uk",
			"SSR": true
		}, { _: "/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
var renderers = [Object.assign({
	"name": "astro:jsx",
	"serverEntrypoint": "file:///Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/node_modules/@astrojs/mdx/dist/server.js"
}, { ssr: {
	name: "astro:jsx",
	check,
...
[
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/analytics/README",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/analytics\\/README\\/?$",
			"segments": [[{
				"content": "analytics",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "src/pages/analytics/README.md",
			"pathname": "/analytics/README",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/analytics/index.astro",
			"pathname": "/analytics",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/articles.astro",
			"pathname": "/articles",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["author"],
			"component": "src/pages/authors/[author].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/authors/index.astro",
			"pathname": "/authors",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["slug"],
			"component": "src/pages/case-studies/[slug].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/case-studies/index.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["category"],
			"component": "src/pages/category/[category].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/research.astro",
			"pathname": "/research",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["tag"],
			"component": "src/pages/tags/[tag].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/videos.astro",
			"pathname": "/videos",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
...
var _page0 = () => import("./chunks/image-passthrough-endpoint_M5-o5m6X.mjs");
var _page1 = () => import("./chunks/README_BdgSgfr2.mjs");
var _page2 = () => import("./chunks/index_DSu1BXhO.mjs");
var _page3 = () => import("./chunks/articles_B2IdpCBH.mjs");
var _page4 = () => import("./chunks/_author__DcWsvZi4.mjs");
var _page5 = () => import("./chunks/index_BnO3YKcm.mjs");
var _page6 = () => import("./chunks/_slug__DkrkkTOG.mjs");
var _page7 = () => import("./chunks/index_Uy4HQFYL.mjs");
var _page8 = () => import("./chunks/_slug__DRJTqtcR.mjs");
var _page9 = () => import("./chunks/index_EMwZMk02.mjs");
var _page10 = () => import("./chunks/_category__BVGJQ-BQ.mjs");
var _page11 = () => import("./chunks/_slug__DNuniv4e.mjs");
var _page12 = () => import("./chunks/index_YbcXZJGO.mjs");
var _page13 = () => import("./chunks/research_B6DHh13s.mjs");
var _page14 = () => import("./chunks/_tag__CtkIK-Tc.mjs");
var _page15 = () => import("./chunks/index_D1CugoHx.mjs");
var _page16 = () => import("./chunks/videos_BdDj4d7H.mjs");
var _page17 = () => import("./chunks/index_D1IBZyJY.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/@astrojs/cloudflare/dist/entrypoints/image-passthrough-endpoint.js", _page0],
	["src/pages/analytics/README.md", _page1],
	["src/pages/analytics/index.astro", _page2],
	["src/pages/articles.astro", _page3],
	["src/pages/authors/[author].astro", _page4],
	...
	["src/pages/category/[category].astro", _page10],
	["src/pages/projects/[slug].astro", _page11],
	["src/pages/projects/index.astro", _page12],
	["src/pages/research.astro", _page13],
	["src/pages/tags/[tag].astro", _page14],
	["src/pages/tags/index.astro", _page15],
	["src/pages/videos.astro", _page16],
	["src/pages/index.astro", _page17]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/","cacheDir":"file:///Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/node_modules/.astro/","outDir":"file:///Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/dist/","srcDir":"file:///Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/","publicDir":"file:///Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/public/","buildClientDir":"file:///Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/dist/client/","buildServerDir":"file:///Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/dist/server/","adapterName":"@astrojs/cloudflare","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/@astrojs/cloudflare/dist/entrypoints/image-passthrough-endpoint.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/analytics/README","isIndex":false,"type":"page","pattern":"^\\/analytics\\/README\\/?$","segments":[[{"content":"analytics","dynamic":false,"spread":false}],[{"content":"README","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/analytics/README.md","pathname":"/analytics/README","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":":root{--bg:#0b1524;--surface:#131f33;--border:#1e2d44;--text:#e8edf4;--muted:#8b99ad;--accent:#4fd1ae}.astro-lm2u5lwk{box-sizing:border-box}body{background:var(--bg);color:var(--text);margin:0;font-family:Inter,system-ui,sans-serif}.page.astro-lm2u5lwk{max-width:960px;margin:0 auto;padding:40px 24px}.header.astro-lm2u5lwk{border-bottom:1px solid var(--border);flex-wrap:wrap;justify-content:space-between;align-items:baseline;gap:12px;margin-bottom:40px;padding-bottom:24px;display:flex}.eyebrow.astro-lm2u5lwk{color:var(--accent);letter-spacing:.12em;margin-bottom:4px;font-family:JetBrains Mono,monospace;font-size:11px}h1.astro-lm2u5lwk{letter-spacing:-.01em;margin:0;font-size:28px}.updated.astro-lm2u5lwk{color:var(--muted);font-family:JetBrains Mono,monospace;font-size:12px}.stat-rail.astro-lm2u5lwk{grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:16px;margin-bottom:48px;display:grid}.stat-card.astro-lm2u5lwk{background:var(--surface);border:1px solid var(--border);border-radius:8px;padding:14px 16px}.stat-label.astro-lm2u5lwk{color:var(--muted);letter-spacing:.04em;text-transform:uppercase;margin-bottom:4px;font-size:10px}.stat-value.astro-lm2u5lwk{font-family:JetBrains Mono,monospace;font-size:20px;font-weight:700}.columns.astro-lm2u5lwk{grid-template-columns:1fr 1fr;gap:32px;margin-bottom:40px;display:grid}@media (width<=640px){.columns.astro-lm2u5lwk{grid-template-columns:1fr}}h2.astro-lm2u5lwk{margin-bottom:16px;font-size:14px;font-weight:600}.list.astro-lm2u5lwk{flex-direction:column;gap:8px;display:flex}.row.astro-lm2u5lwk{background:var(--surface);border:1px solid var(--border);border-radius:8px;justify-content:space-between;padding:10px 14px;font-size:13px;display:flex}.row-label.astro-lm2u5lwk{color:var(--text)}.row-value.astro-lm2u5lwk{color:var(--accent);font-family:JetBrains Mono,monospace}footer.astro-lm2u5lwk{color:var(--muted);border-top:1px solid var(--border);padding-top:20px;font-size:11px}\n"}],"routeData":{"route":"/analytics","isIndex":true,"type":"page","pattern":"^\\/analytics\\/?$","segments":[[{"content":"analytics","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/analytics/index.astro","pathname":"/analytics","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.CnQ2mCbQ.css"}],"routeData":{"route":"/articles","isIndex":false,"type":"page","pattern":"^\\/articles\\/?$","segments":[[{"content":"articles","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/articles.astro","pathname":"/articles","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.CnQ2mCbQ.css"}],"routeData":{"route":"/authors/[author]","isIndex":false,"type":"page","pattern":"^\\/authors\\/([^/]+?)\\/?$","segments":[[{"content":"authors","dynamic":false,"spread":false}],[{"content":"author","dynamic":true,"spread":false}]],"params":["author"],"component":"src/pages/authors/[author].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.CnQ2mCbQ.css"}],"routeData":{"route":"/authors","isIndex":true,"type":"page","pattern":"^\\/authors\\/?$","segments":[[{"content":"authors","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/authors/index.astro","pathname":"/authors","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.CnQ2mCbQ.css"},{"type":"inline","content":".fact-box.astro-w4livwtr{background:var(--color-surface,#f7f7f5);border:1px solid var(--color-border,#e5e5e5);border-left:3px solid var(--color-accent,#3949ab);border-radius:4px;margin-block:1.75rem;padding:1.1rem 1.3rem}.label.astro-w4livwtr{letter-spacing:.08em;text-transform:uppercase;color:var(--color-accent,#3949ab);margin:0 0 .5rem;font-size:.7rem;font-weight:700}.content.astro-w4livwtr{font-size:.95rem;line-height:1.6}.content.astro-w4livwtr ul{margin:0;padding-left:1.2rem}.content.astro-w4livwtr p:last-child{margin-bottom:0}.callout.astro-q2ml7llr{border:1px solid #0000;border-radius:6px;gap:.75rem;margin-block:1.75rem;padding:1rem 1.2rem;display:flex}.callout.astro-q2ml7llr .icon.astro-q2ml7llr{flex-shrink:0;font-size:1rem;line-height:1.5}.label.astro-q2ml7llr{letter-spacing:.04em;text-transform:uppercase;margin:0 0 .25rem;font-size:.75rem;font-weight:700}.content.astro-q2ml7llr{font-size:.95rem;line-height:1.6}.content.astro-q2ml7llr p:last-child{margin-bottom:0}.note.astro-q2ml7llr{background:#eef3fb;border-color:#cfe0f5}.note.astro-q2ml7llr .label.astro-q2ml7llr,.note.astro-q2ml7llr .icon.astro-q2ml7llr{color:#2563a8}.tip.astro-q2ml7llr{background:#eef8f1;border-color:#cbe8d4}.tip.astro-q2ml7llr .label.astro-q2ml7llr,.tip.astro-q2ml7llr .icon.astro-q2ml7llr{color:#1f8a4c}.warning.astro-q2ml7llr{background:#fdf3ea;border-color:#f2ddc2}.warning.astro-q2ml7llr .label.astro-q2ml7llr,.warning.astro-q2ml7llr .icon.astro-q2ml7llr{color:#b3661a}.post-figure.astro-khyig4bw{margin:2rem 0}.post-figure.astro-khyig4bw.wide{text-align:center;max-width:100vw;margin-inline:calc(50% - 50vw)}.post-figure.astro-khyig4bw img.astro-khyig4bw{border-radius:4px;width:100%;height:auto;display:block}.post-figure.astro-khyig4bw.wide img.astro-khyig4bw{border-radius:0;max-width:1100px;margin-inline:auto}figcaption.astro-khyig4bw{color:var(--color-text-muted,#666);text-align:center;margin-top:.5rem;font-size:.8rem}.credit.astro-khyig4bw{opacity:.75}\n"}],"routeData":{"route":"/blog/[slug]","isIndex":false,"type":"page","pattern":"^\\/blog\\/([^/]+?)\\/?$","segments":[[{"content":"blog","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/blog/[slug].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.CnQ2mCbQ.css"},{"type":"inline","content":".category-badge.astro-qonxvewj{background:var(--color-accent-subtle,#eef1fb);color:var(--color-accent,#3949ab);letter-spacing:.02em;text-transform:capitalize;border-radius:999px;padding:.2rem .65rem;font-size:.75rem;font-weight:600;text-decoration:none;transition:background .15s;display:inline-block}a.astro-qonxvewj.category-badge:hover{background:var(--color-accent,#3949ab);color:#fff}.post-card.astro-sbmovh4h{color:inherit;border:1px solid var(--color-border,#e5e5e5);border-radius:8px;flex-direction:column;text-decoration:none;transition:border-color .15s,transform .15s;display:flex;overflow:hidden}.post-card.astro-sbmovh4h:hover{border-color:var(--color-accent,#3949ab);transform:translateY(-2px)}.thumb.astro-sbmovh4h{aspect-ratio:16/9;object-fit:cover;width:100%}.body.astro-sbmovh4h{flex-direction:column;gap:.5rem;padding:1.1rem 1.2rem 1.3rem;display:flex}h3.astro-sbmovh4h{margin:0;font-size:1.1rem;line-height:1.3}.featured.astro-sbmovh4h h3.astro-sbmovh4h{font-size:1.5rem}.description.astro-sbmovh4h{color:var(--color-text-muted,#666);-webkit-line-clamp:2;-webkit-box-orient:vertical;margin:0;font-size:.9rem;display:-webkit-box;overflow:hidden}.footer.astro-sbmovh4h{color:var(--color-text-muted,#666);margin-top:.3rem;font-size:.78rem}.featured.astro-sbmovh4h{grid-column:1/-1}@media (width>=700px){.featured.astro-sbmovh4h{flex-direction:row}.featured.astro-sbmovh4h .thumb.astro-sbmovh4h{aspect-ratio:auto;width:55%}.featured.astro-sbmovh4h .body.astro-sbmovh4h{flex:1;justify-content:center}}\n.blog-index.astro-x255k2k2{max-width:1100px;margin-inline:auto;padding:2.5rem 1.5rem 4rem}.index-header.astro-x255k2k2{flex-wrap:wrap;justify-content:space-between;align-items:baseline;gap:1rem;margin-bottom:2rem;display:flex}h1.astro-x255k2k2{margin:0;font-size:2rem}.category-nav.astro-x255k2k2{flex-wrap:wrap;gap:1rem;display:flex}.category-nav.astro-x255k2k2 a.astro-x255k2k2{text-transform:capitalize;color:var(--color-text-muted,#666);font-size:.85rem;text-decoration:none}.category-nav.astro-x255k2k2 a.astro-x255k2k2:hover{color:var(--color-accent,#3949ab)}.featured-slot.astro-x255k2k2{margin-bottom:2.5rem}.grid.astro-x255k2k2{grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:1.75rem;display:grid}\n"}],"routeData":{"route":"/blog","isIndex":true,"type":"page","pattern":"^\\/blog\\/?$","segments":[[{"content":"blog","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/blog/index.astro","pathname":"/blog","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.CnQ2mCbQ.css"}],"routeData":{"route":"/case-studies/[slug]","isIndex":false,"type":"page","pattern":"^\\/case-studies\\/([^/]+?)\\/?$","segments":[[{"content":"case-studies","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/case-studies/[slug].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.CnQ2mCbQ.css"}],"routeData":{"route":"/case-studies","isIndex":true,"type":"page","pattern":"^\\/case-studies\\/?$","segments":[[{"content":"case-studies","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/case-studies/index.astro","pathname":"/case-studies","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.CnQ2mCbQ.css"},{"type":"inline","content":".category-badge.astro-qonxvewj{background:var(--color-accent-subtle,#eef1fb);color:var(--color-accent,#3949ab);letter-spacing:.02em;text-transform:capitalize;border-radius:999px;padding:.2rem .65rem;font-size:.75rem;font-weight:600;text-decoration:none;transition:background .15s;display:inline-block}a.astro-qonxvewj.category-badge:hover{background:var(--color-accent,#3949ab);color:#fff}.post-card.astro-sbmovh4h{color:inherit;border:1px solid var(--color-border,#e5e5e5);border-radius:8px;flex-direction:column;text-decoration:none;transition:border-color .15s,transform .15s;display:flex;overflow:hidden}.post-card.astro-sbmovh4h:hover{border-color:var(--color-accent,#3949ab);transform:translateY(-2px)}.thumb.astro-sbmovh4h{aspect-ratio:16/9;object-fit:cover;width:100%}.body.astro-sbmovh4h{flex-direction:column;gap:.5rem;padding:1.1rem 1.2rem 1.3rem;display:flex}h3.astro-sbmovh4h{margin:0;font-size:1.1rem;line-height:1.3}.featured.astro-sbmovh4h h3.astro-sbmovh4h{font-size:1.5rem}.description.astro-sbmovh4h{color:var(--color-text-muted,#666);-webkit-line-clamp:2;-webkit-box-orient:vertical;margin:0;font-size:.9rem;display:-webkit-box;overflow:hidden}.footer.astro-sbmovh4h{color:var(--color-text-muted,#666);margin-top:.3rem;font-size:.78rem}.featured.astro-sbmovh4h{grid-column:1/-1}@media (width>=700px){.featured.astro-sbmovh4h{flex-direction:row}.featured.astro-sbmovh4h .thumb.astro-sbmovh4h{aspect-ratio:auto;width:55%}.featured.astro-sbmovh4h .body.astro-sbmovh4h{flex:1;justify-content:center}}\n.archive.astro-elr3iqgh{max-width:1100px;margin-inline:auto;padding:2.5rem 1.5rem 4rem}.eyebrow.astro-elr3iqgh{letter-spacing:.08em;text-transform:uppercase;color:var(--color-accent,#3949ab);margin:0 0 .3rem;font-size:.75rem;font-weight:700}h1.astro-elr3iqgh{text-transform:capitalize;margin:0 0 2rem}.grid.astro-elr3iqgh{grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:1.75rem;display:grid}\n"}],"routeData":{"route":"/category/[category]","isIndex":false,"type":"page","pattern":"^\\/category\\/([^/]+?)\\/?$","segments":[[{"content":"category","dynamic":false,"spread":false}],[{"content":"category","dynamic":true,"spread":false}]],"params":["category"],"component":"src/pages/category/[category].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.CnQ2mCbQ.css"}],"routeData":{"route":"/projects/[slug]","isIndex":false,"type":"page","pattern":"^\\/projects\\/([^/]+?)\\/?$","segments":[[{"content":"projects","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/projects/[slug].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.CnQ2mCbQ.css"}],"routeData":{"route":"/projects","isIndex":true,"type":"page","pattern":"^\\/projects\\/?$","segments":[[{"content":"projects","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/projects/index.astro","pathname":"/projects","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.CnQ2mCbQ.css"}],"routeData":{"route":"/research","isIndex":false,"type":"page","pattern":"^\\/research\\/?$","segments":[[{"content":"research","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/research.astro","pathname":"/research","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.CnQ2mCbQ.css"},{"type":"inline","content":".category-badge.astro-qonxvewj{background:var(--color-accent-subtle,#eef1fb);color:var(--color-accent,#3949ab);letter-spacing:.02em;text-transform:capitalize;border-radius:999px;padding:.2rem .65rem;font-size:.75rem;font-weight:600;text-decoration:none;transition:background .15s;display:inline-block}a.astro-qonxvewj.category-badge:hover{background:var(--color-accent,#3949ab);color:#fff}.post-card.astro-sbmovh4h{color:inherit;border:1px solid var(--color-border,#e5e5e5);border-radius:8px;flex-direction:column;text-decoration:none;transition:border-color .15s,transform .15s;display:flex;overflow:hidden}.post-card.astro-sbmovh4h:hover{border-color:var(--color-accent,#3949ab);transform:translateY(-2px)}.thumb.astro-sbmovh4h{aspect-ratio:16/9;object-fit:cover;width:100%}.body.astro-sbmovh4h{flex-direction:column;gap:.5rem;padding:1.1rem 1.2rem 1.3rem;display:flex}h3.astro-sbmovh4h{margin:0;font-size:1.1rem;line-height:1.3}.featured.astro-sbmovh4h h3.astro-sbmovh4h{font-size:1.5rem}.description.astro-sbmovh4h{color:var(--color-text-muted,#666);-webkit-line-clamp:2;-webkit-box-orient:vertical;margin:0;font-size:.9rem;display:-webkit-box;overflow:hidden}.footer.astro-sbmovh4h{color:var(--color-text-muted,#666);margin-top:.3rem;font-size:.78rem}.featured.astro-sbmovh4h{grid-column:1/-1}@media (width>=700px){.featured.astro-sbmovh4h{flex-direction:row}.featured.astro-sbmovh4h .thumb.astro-sbmovh4h{aspect-ratio:auto;width:55%}.featured.astro-sbmovh4h .body.astro-sbmovh4h{flex:1;justify-content:center}}\n.archive.astro-aezt6mnq{max-width:1100px;margin-inline:auto;padding:2.5rem 1.5rem 4rem}.eyebrow.astro-aezt6mnq{letter-spacing:.08em;text-transform:uppercase;color:var(--color-accent,#3949ab);margin:0 0 .3rem;font-size:.75rem;font-weight:700}h1.astro-aezt6mnq{margin:0 0 2rem}.grid.astro-aezt6mnq{grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:1.75rem;display:grid}\n"}],"routeData":{"route":"/tags/[tag]","isIndex":false,"type":"page","pattern":"^\\/tags\\/([^/]+?)\\/?$","segments":[[{"content":"tags","dynamic":false,"spread":false}],[{"content":"tag","dynamic":true,"spread":false}]],"params":["tag"],"component":"src/pages/tags/[tag].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.CnQ2mCbQ.css"}],"routeData":{"route":"/tags","isIndex":true,"type":"page","pattern":"^\\/tags\\/?$","segments":[[{"content":"tags","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/tags/index.astro","pathname":"/tags","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.CnQ2mCbQ.css"},{"type":"inline","content":".pub.astro-u3mppovw{isolation:isolate;transition:transform .18s,box-shadow .18s,border-color .18s;position:relative;overflow:hidden}.pub.astro-u3mppovw:before{content:\"\";pointer-events:none;border-radius:inherit;opacity:0;z-index:0;background:linear-gradient(#ffffff05,#00000005);transition:opacity .18s;position:absolute;inset:0}.pub.astro-u3mppovw:hover{border-color:color-mix(in srgb, currentColor 24%, transparent);transform:translateY(-4px);box-shadow:0 18px 40px #0000001f}.pub.astro-u3mppovw:hover:before{opacity:1}.pn.astro-u3mppovw,.pm.astro-u3mppovw,.pa.astro-u3mppovw{z-index:2;position:relative}.pub-media.astro-u3mppovw{z-index:3;aspect-ratio:16/9;background:#111;border-radius:1rem;width:100%;margin-bottom:1rem;position:relative;overflow:hidden}.pub-video.astro-u3mppovw iframe.astro-u3mppovw,.pub-image.astro-u3mppovw img.astro-u3mppovw{border:0;width:100%;height:100%;display:block}.pub-image.astro-u3mppovw img.astro-u3mppovw{object-fit:cover}.pub-top.astro-u3mppovw{gap:.35rem;margin-bottom:.7rem;display:grid}.pub-top.astro-u3mppovw h3.astro-u3mppovw{margin:0;line-height:1.15}.startDate.astro-u3mppovw{opacity:.72;font-size:.9rem}.client-badge.astro-u3mppovw{border:1px solid color-mix(in srgb, currentColor 12%, transparent);background:color-mix(in srgb, currentColor 4%, transparent);border-radius:999px;width:fit-content;margin-bottom:.85rem;padding:.35rem .65rem;font-size:.78rem;line-height:1;display:inline-flex}.video-gallery.astro-dvozwlp7{padding-block:clamp(4rem,7vw,7rem)}.vg-shell.astro-dvozwlp7{gap:clamp(1.5rem,3vw,2.5rem);display:grid}.vg-head.astro-dvozwlp7{gap:1rem;max-width:78rem;margin-bottom:.5rem;display:grid}.eyebrow.astro-dvozwlp7{text-transform:uppercase;letter-spacing:.14em;opacity:.72;margin:0;font-size:.78rem}.vg-head.astro-dvozwlp7 h2.astro-dvozwlp7{margin:0;font-size:clamp(2rem,4vw,3.5rem);line-height:1.05}.vg-intro.astro-dvozwlp7{border-left:3px solid color-mix(in srgb, currentColor 28%, transparent);background:color-mix(in srgb, currentColor 4%, transparent);border-radius:.9rem;gap:.85rem;max-width:72ch;padding:1rem 1.25rem;display:grid}.vg-lead.astro-dvozwlp7,.vg-note.astro-dvozwlp7{margin:0;line-height:1.65}.vg-lead.astro-dvozwlp7{opacity:.96;font-size:1.08rem;font-weight:500}.vg-note.astro-dvozwlp7{opacity:.84;font-size:.98rem}.vg-filters.astro-dvozwlp7{grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:1rem;margin-top:.5rem;display:grid}.filter-field.astro-dvozwlp7{gap:.45rem;display:grid}.filter-field.astro-dvozwlp7 span.astro-dvozwlp7{text-transform:uppercase;letter-spacing:.12em;opacity:.7;font-size:.82rem}.filter-field.astro-dvozwlp7 select.astro-dvozwlp7{border:1px solid color-mix(in srgb, currentColor 14%, transparent);color:currentColor;width:100%;font:inherit;background:0 0;border-radius:.9rem;padding:.75rem .9rem}.filter-field.astro-dvozwlp7 select.astro-dvozwlp7 option.astro-dvozwlp7{color:#111;background:#fff}.vg-grid.astro-dvozwlp7{grid-template-columns:1fr;align-items:stretch;gap:1.5rem;display:grid}.video-item.astro-dvozwlp7[hidden]{display:none}\n"}],"routeData":{"route":"/videos","isIndex":false,"type":"page","pattern":"^\\/videos\\/?$","segments":[[{"content":"videos","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/videos.astro","pathname":"/videos","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.CnQ2mCbQ.css"},{"type":"external","src":"_astro/index.BsZpzIrb.css"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","site":"https://rjmlaird.co.uk","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/pages/articles.astro",{"propagation":"none","containsHead":true}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/pages/authors/[author].astro",{"propagation":"in-tree","containsHead":true}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/pages/authors/index.astro",{"propagation":"in-tree","containsHead":true}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/pages/blog/[slug].astro",{"propagation":"in-tree","containsHead":true}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/pages/blog/index.astro",{"propagation":"in-tree","containsHead":true}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/pages/case-studies/[slug].astro",{"propagation":"in-tree","containsHead":true}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/pages/case-studies/index.astro",{"propagation":"in-tree","containsHead":true}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/pages/category/[category].astro",{"propagation":"in-tree","containsHead":true}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/pages/index.astro",{"propagation":"in-tree","containsHead":true}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/pages/projects/[slug].astro",{"propagation":"in-tree","containsHead":true}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/pages/projects/index.astro",{"propagation":"in-tree","containsHead":true}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/pages/research.astro",{"propagation":"none","containsHead":true}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/pages/tags/[tag].astro",{"propagation":"in-tree","containsHead":true}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/pages/tags/index.astro",{"propagation":"in-tree","containsHead":true}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/pages/videos.astro",{"propagation":"none","containsHead":true}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/pages/analytics/index.astro",{"propagation":"none","containsHead":true}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/content/blog/seo-for-space-orgs-2026.mdx?astroPropagatedAssets",{"propagation":"in-tree","containsHead":false}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/.astro/content-modules.mjs",{"propagation":"in-tree","containsHead":false}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/node_modules/astro/dist/content/runtime.js",{"propagation":"in-tree","containsHead":false}],["\u0000astro:content",{"propagation":"in-tree","containsHead":false}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/content.config.ts",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/blog/index@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:pages",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:manifest",{"propagation":"in-tree","containsHead":false}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/node_modules/astro/dist/core/app/entrypoints/virtual/prod.js",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:app",{"propagation":"in-tree","containsHead":false}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/node_modules/astro/dist/core/app/entrypoints/virtual/index.js",{"propagation":"in-tree","containsHead":false}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/node_modules/@astrojs/cloudflare/dist/utils/handler.js",{"propagation":"in-tree","containsHead":false}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/node_modules/@astrojs/cloudflare/dist/entrypoints/server.js",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:cloudflare/worker-entry",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/category/[category]@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/authors/[author]@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/authors/index@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/blog/[slug]@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/case-studies/[slug]@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/case-studies/index@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/projects/[slug]@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/projects/index@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/tags/[tag]@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/tags/index@_@astro",{"propagation":"in-tree","containsHead":false}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/sections/blog.section.astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:page:src/pages/index@_@astro",{"propagation":"in-tree","containsHead":false}],["/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/sections/projects.section.astro",{"propagation":"in-tree","containsHead":false}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"virtual:cloudflare/worker-entry":"entry.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_q0HM18kM.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_TyipGO2P.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_BYLrzUxc.mjs","/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/node_modules/@astrojs/cloudflare/dist/utils/static-image-collection.js":"chunks/static-image-collection_CW9hZDn0.mjs","\u0000virtual:astro:page:src/pages/analytics/README@_@md":"chunks/README_BdgSgfr2.mjs","\u0000astro:data-layer-content":"chunks/_astro_data-layer-content_WRRqJOH1.mjs","\u0000virtual:astro:page:src/pages/authors/[author]@_@astro":"chunks/_author__DcWsvZi4.mjs","\u0000virtual:astro:page:src/pages/category/[category]@_@astro":"chunks/_category__BVGJQ-BQ.mjs","\u0000virtual:astro:page:src/pages/projects/[slug]@_@astro":"chunks/_slug__DNuniv4e.mjs","\u0000virtual:astro:page:src/pages/case-studies/[slug]@_@astro":"chunks/_slug__DRJTqtcR.mjs","\u0000virtual:astro:page:src/pages/blog/[slug]@_@astro":"chunks/_slug__DkrkkTOG.mjs","\u0000virtual:astro:page:src/pages/tags/[tag]@_@astro":"chunks/_tag__CtkIK-Tc.mjs","\u0000virtual:astro:get-image":"chunks/_virtual_astro_get-image_C8rKGcFU.mjs","\u0000virtual:astro:page:src/pages/articles@_@astro":"chunks/articles_B2IdpCBH.mjs","/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/.astro/content-assets.mjs":"chunks/content-assets_CdozlZz2.mjs","/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/.astro/content-modules.mjs":"chunks/content-modules_BIxrKQha.mjs","\u0000virtual:astro:page:node_modules/@astrojs/cloudflare/dist/entrypoints/image-passthrough-endpoint@_@js":"chunks/image-passthrough-endpoint_M5-o5m6X.mjs","\u0000virtual:astro:page:src/pages/authors/index@_@astro":"chunks/index_BnO3YKcm.mjs","\u0000virtual:astro:page:src/pages/tags/index@_@astro":"chunks/index_D1CugoHx.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_D1IBZyJY.mjs","\u0000virtual:astro:page:src/pages/analytics/index@_@astro":"chunks/index_DSu1BXhO.mjs","\u0000virtual:astro:page:src/pages/case-studies/index@_@astro":"chunks/index_EMwZMk02.mjs","\u0000virtual:astro:page:src/pages/blog/index@_@astro":"chunks/index_Uy4HQFYL.mjs","\u0000virtual:astro:page:src/pages/projects/index@_@astro":"chunks/index_YbcXZJGO.mjs","/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/node_modules/node-fetch/src/utils/multipart-parser.js":"chunks/multipart-parser_wkCIpttu.mjs","/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/node_modules/astro/dist/assets/services/noop.js":"chunks/noop_CZPfBvOh.mjs","\u0000virtual:astro:page:src/pages/research@_@astro":"chunks/research_B6DHh13s.mjs","/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/content/blog/seo-for-space-orgs-2026.mdx?astroPropagatedAssets":"chunks/seo-for-space-orgs-2026_BKG6erDQ.mjs","/Volumes/DevProjects/rjmlaird/rjmlaird.co.uk/src/content/blog/seo-for-space-orgs-2026.mdx":"chunks/seo-for-space-orgs-2026_CGmfCFiN.mjs","\u0000virtual:astro:page:src/pages/videos@_@astro":"chunks/videos_BdDj4d7H.mjs","virtual:astro:noop":"_astro/_virtual_astro_noop.CYK_omFk.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[],"assets":["/_astro/seo-space-organisations-2026.LNV1ZOqP.jpg","/_astro/Layout.CnQ2mCbQ.css","/_astro/index.BsZpzIrb.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"u8PheHLjROkmoH+RYc+Dk3rC2Vs1M3YPcp15IYMFiXY=","sessionConfig":{"driver":"unstorage/drivers/cloudflare-kv-binding","options":{"binding":"SESSION"}},"image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
