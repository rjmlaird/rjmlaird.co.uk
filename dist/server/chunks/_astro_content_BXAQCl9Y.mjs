...
import { A as object, C as array, E as date, H as createHeadAndContent, K as unescapeHTML, L as safeParseAsync, N as string, P as union, Z as escape, h as renderTemplate, i as renderUniqueStylesheet, k as number, n as spreadAttributes, r as renderScriptElement, s as renderComponent, v as generateCspDigest } from "./server_ClKh5Vov.mjs";
...
import { E as LiveContentConfigError, G as RenderUndefinedEntryError, et as UnknownContentCollectionError, n as AstroUserError, t as AstroError } from "./errors_BL7sPB4q.mjs";
...
var ImmutableDataStore = class ImmutableDataStore {
	...
	*/
	static async fromModule() {
		try {
			const data = await import("./_astro_data-layer-content_WRRqJOH1.mjs");
...
async function updateImageReferencesInBody(html, fileName) {
	...
	const { getImage } = await import("./_virtual_astro_get-image_C8rKGcFU.mjs");
...
async function renderEntry(entry) {
	...
	if (entry.deferredRender) try {
		const { default: contentModules } = await import("./content-modules_BIxrKQha.mjs");
