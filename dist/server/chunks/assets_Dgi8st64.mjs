...
import { E as InvalidImageService, G as RemoteImageNotAllowed, L as NoImageMetadata, O as LocalImageUsedWrongly, P as MissingImageDimension, S as IncompatibleDescriptorOptions, d as ExpectedImageOptions, f as ExpectedNotESMImage, n as AstroError, nt as UnsupportedImageConversion, p as FailedToFetchRemoteImageDimensions, rt as UnsupportedImageFormat, t as shorthash, u as ExpectedImage } from "./shorthash_Xgn77Kwt.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./image-service-workerd_DZoAWSLs.mjs").catch((e) => {
