...
import { c as isRemotePath, l as joinPaths, p as removeQueryString } from "./path_BqUacSWD.mjs";
import { D as LocalImageUsedWrongly, I as NoImageMetadata, N as MissingImageDimension, T as InvalidImageService, W as RemoteImageNotAllowed, d as ExpectedNotESMImage, f as FailedToFetchRemoteImageDimensions, l as ExpectedImage, nt as UnsupportedImageFormat, t as AstroError, tt as UnsupportedImageConversion, u as ExpectedImageOptions, x as IncompatibleDescriptorOptions } from "./errors_BL7sPB4q.mjs";
import { t as shorthash } from "./shorthash_BMJi2pTU.mjs";
import { t as isRemoteAllowed } from "./remote_Cm3aSJjJ.mjs";
import { i as VALID_SUPPORTED_FORMATS, n as DEFAULT_OUTPUT_FORMAT, t as DEFAULT_HASH_PROPS } from "./consts_HylFXJJn.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./noop_CZPfBvOh.mjs").catch((e) => {
...
//#endregion
export { baseService as a, fetchWithRedirects as c, resolveSrc as d, getImage as i, isESMImportedImage as l, propsToFilename as n, verifyOptions as o, getConfiguredImageService as r, inferRemoteSize as s, hashTransform as t, isRemoteImage as u };
